...
import DataStructures.SortedLinkedListMultiset;

public class DataGeneratorSortlLinkedList {
	...
	public static void main(String[] args) {
		System.out.println("Sorted LinkedList testing");
		...
		int size5 = 50000;
		int size6 = 100000;
		SortedLinkedListMultiset<String> orderList1 = new SortedLinkedListMultiset<String>();
		SortedLinkedListMultiset<String> orderList2 = new SortedLinkedListMultiset<String>();
		SortedLinkedListMultiset<String> orderList3 = new SortedLinkedListMultiset<String>();
		SortedLinkedListMultiset<String> orderList4 = new SortedLinkedListMultiset<String>();
		SortedLinkedListMultiset<String> orderList5 = new SortedLinkedListMultiset<String>();
		SortedLinkedListMultiset<String> orderList6 = new SortedLinkedListMultiset<String>();
